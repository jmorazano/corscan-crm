...
Feature en curso: **020-inbound-media** (el agente ve y escucha: las notas
de voz y las imágenes que manda el cliente se descargan, se guardan, se
transcriben o se describen con IA, y entran al turno del agente; la bandeja
las muestra) — spec, plan y tasks en
[specs/020-inbound-media/](specs/020-inbound-media/spec.md).
Anterior: 019-admin-organizations (en producción, 4cb1741).
<!-- SPECKIT END -->
