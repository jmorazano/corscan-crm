...
Feature en curso: **021-stays-detail** (barrio y detalles del alojamiento
que el condensado del MCP tiraba, precios fuera del mensaje de WhatsApp con
guarda propia, un solo enlace que lleve a la búsqueda, y el nombre del
huésped guardado sin pisar el del equipo) — spec, plan y tasks en
[specs/021-stays-detail/](specs/021-stays-detail/spec.md).
Anterior: 020-inbound-media (rama `020-inbound-media`, commit 60a09f4, sin
deployar: se mergea junto con esta).
<!-- SPECKIT END -->
