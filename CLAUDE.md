...
Feature en curso: **023-instagram-direct** (Instagram Direct como segundo
canal en la misma Bandeja: conexión por Business Login for Instagram, ingesta
y envío por graph.instagram.com, agente, filtros por canal; constitución
1.8.0) — spec, plan y tasks en
[specs/023-instagram-direct/](specs/023-instagram-direct/spec.md).
Anterior: 022-member-scope-delay-images (en producción, deploy 2cbbe6d4, 24-sep-2026).
