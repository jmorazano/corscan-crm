...
Feature en curso: **017-whatsapp-history** (importación del historial del
celular por coexistence: `smb_app_data` → webhooks `history` /
`smb_message_echoes` / `smb_app_state_sync`, 60 días por defecto, camino de
ingesta propio sin efectos de entrante, ecos «Desde el celular», el agente
calla si lo último es del negocio) — spec, plan y tasks en
[specs/017-whatsapp-history/](specs/017-whatsapp-history/spec.md).
Anterior: 016-mcp-connector (en producción, ac550d5).
<!-- SPECKIT END -->
