...
Feature en curso: **022-member-scope-delay-images** (miembros sin
configuración —tres capas: nav, página, API—, espera del agente antes de
responder configurable por empresa, e imágenes en el Entrenador leídas por
un modelo de visión elegible en Ajustes → IA) — spec, plan y tasks en
[specs/022-member-scope-delay-images/](specs/022-member-scope-delay-images/spec.md).
Anterior: 021-stays-detail (en producción, deploy da1451e1, 24-sep-2026).
